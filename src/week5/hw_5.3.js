...
You must figure out the GPA that each student has achieved in a class and then average
those numbers to get a class average.
After that, you just need to sort.
The hardest class is class_id=2.
...
db.grades.aggregate([
	...
	{$group : {_id : {student: '$student_id', class : '$class_id'}, avg: {$avg : '$scores.score'}}},
